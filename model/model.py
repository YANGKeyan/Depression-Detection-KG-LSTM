# -*- coding: utf-8 -*-
#一个LSTM层和三个attention层 
#selfattention层用于从文本序列中提取出一个文本表示
#cstattention层用于计算文本序列中每个单词对分类结果的贡献
#ccsattention层用于计算每个单词在整个文本序列中的重要性
#最后，将这三个attention层的结果加权求和，得到最终的文本表示，用于分类任务。
